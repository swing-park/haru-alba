  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        <h1 className="text-xl font-bold mb-6 dark:text-slate-100">내 지원 현황</h1>
            ...
            {applications.map((app) => (
              <div key={app._id} className="bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-700">
                <div className="flex justify-between items-start mb-2">
                  <h2 className="font-semibold dark:text-slate-100">{app.jobId.title}</h2>
                ...
                {app.status === 'confirmed' && (
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-2 text-sm text-green-700 dark:text-green-400 mb-2">
